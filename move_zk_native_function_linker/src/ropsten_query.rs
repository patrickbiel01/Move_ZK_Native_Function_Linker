...
pub async fn sample_proof() -> DecodedParams {
	...
	//Get identifier of latest block
	let curr_block_num: U64 = web3::types::U64::from_dec_str("11007501").expect("");
	...
	return decode_proof(&encoded_input).expect("Thing");
}